	...
	return (
		<>
			<Helmet>
				...
				<meta property="og:url" content="https://pprmint.art/projects/2022/archwall" />
			</Helmet>
			...
			<div className="content">
				<div className="section">
					<a href="https://media.pprmint.art/2022/ArchWall/Arch_Qogir.png" target="_blank">
						<Image
				...
				<div className="section">
					<a href="https://media.pprmint.art/2022/ArchWall/screenshot.png" target="_blank">
						<Image
