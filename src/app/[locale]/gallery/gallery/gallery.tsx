            ...
            {works.works.data.map((work) => (
                <Dialog.Root key={work.id}>
                    <Dialog.Trigger asChild>
                        <button
                            className="group/button relative overflow-clip cursor-pointer aspect-video bg-neutral-900 hover:bg-neutral-50 active:bg-neutral-950 duration-250 active:duration-75 ease-out-quint"
                        >
                            <Image
                                ...
                                alt=""
                                className={`h-full min-w-full object-cover ${work.attributes.coverFocus} group-hover/button:opacity-90 duration-250 ease-out-quint group-focus-visible/button:animate-pulse`}
                            />
                        </button>
                    </Dialog.Trigger>
                    <Dialog.Portal>
