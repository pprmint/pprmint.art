		...
		<div className={`flex flex-row ${props.className}`}>
			...
			<div className="flex text-neutral-50 md:text-xl ml-auto">
				<Link
					...
					target="_blank"
					rel="noopener noreferrer"
					className="size-9 flex items-center justify-center rounded-full hover:bg-neutral-800 duration-100 active:duration-50 active:opacity-75 active:shadow-inner"
				>
